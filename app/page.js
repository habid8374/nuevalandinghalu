...
export default function Home() {
  ...
  return (
    <div className="bg-[#F8F6F3] text-[#2C2C2C] overflow-x-hidden">
      ...
      {/* Hero móvil: video como franja + contenido debajo */}
      <div className="block md:hidden">
        <div className="relative w-full overflow-hidden" style={{height: '220px'}}>
          <video autoPlay muted loop playsInline className="w-full h-full" style={{objectFit:'cover', objectPosition:'center center'}}>
            <source src="/fondo-hero.mp4" type="video/mp4" />
          </video>
          <div className="absolute inset-0" style={{background: 'rgba(248,246,243,0.30)'}} />
        </div>
        <div className="px-6 pt-8 pb-16 bg-[#F8F6F3]">
          ...
          <h1 className="font-display font-bold text-5xl leading-[1.1] mb-6 text-[#1B4B7A]">
            Todo el colegio,{' '}
          ...
          <p className="text-lg text-[#1B4B7A] font-medium mb-8 leading-relaxed">
          ...
          <div className="flex flex-col gap-4">
            <Button size="lg" onClick={scrollToContact} className="bg-[#1B4B7A] hover:bg-[#143A62] text-white font-semibold px-8 py-6 text-lg group w-full">
              Solicita una demostración
              <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </Button>
            <Button size="lg" variant="outline" onClick={() => window.open('https://wa.me/573246868538', '_blank')} className="border-2 border-[#1B4B7A] text-[#1B4B7A] hover:bg-[#1B4B7A] hover:text-white font-semibold px-8 py-6 text-lg w-full">
      ...
      {/* Hero desktop: video fondo completo */}
      <section className="relative pt-28 pb-16 px-6 overflow-hidden items-center min-h-screen hidden md:flex">
